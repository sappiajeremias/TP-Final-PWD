...
?>
    <!-- INCLUIMOS MODALES -->
    <?php include '../Modales/Productos/modal_add_producto.php'; ?>
    <?php include '../Modales/Productos/modal_editar_producto.php'; ?>
    <?php include '../Modales/Productos/modal_editar_imagen.php'; ?>
